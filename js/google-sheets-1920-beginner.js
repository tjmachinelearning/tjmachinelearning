...
function drawVisualization() {
    ...
    query.setQuery('SELECT A, B, C, D, E, F, G label A "Name", B "Decision Trees Pset", C "Decision Trees Comp", D "Random Forest Comp", E "SVM Comp", F "Neural Net Comp", G "Total"');
